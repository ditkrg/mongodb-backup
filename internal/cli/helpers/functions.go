...
func ChooseDatabaseToRestore(s3Service *services.S3Service, ctx context.Context, bucket string, prefix string, showOption func(string) bool) (backupToRestore string) {
