...
type MongoPitrRestoreFlags struct {
	...
	// RestoreDBUsersAndRoles   bool           `env:"RESTORE_DB_USERS_AND_ROLES" negatable:"" default:"true" help:"Testore user and role definitions for the given database (Default: true)"`
